<?php $__env->startSection('header'); ?>
	<!--flex slider-->
	<script defer src="<?php echo e(asset('theme_assets')); ?>/js/jquery.flexslider.js"></script>
	<link rel="stylesheet" href="<?php echo e(asset('theme_assets')); ?>/css/flexslider.css" type="text/css" media="screen" />
	...
	<!--flex slider-->
	<script src="<?php echo e(asset('theme_assets')); ?>/js/imagezoom.js"></script>

	
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('theme_assets/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css')); ?>">
	<script src="<?php echo e(asset('theme_assets/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js')); ?>"></script>
	<script>
		$(function() {
	   	 ...
	   	 <div class="single-main">
	   	 	<div class="single-top-main">
				   ...
				   <div class="flexslider">
					  <ul class="slides">
					    <li data-thumb="<?php echo e(asset('theme_assets')); ?>/images/si1.jpg">
					        <div class="thumb-image"> <img src="<?php echo e(asset('theme_assets')); ?>/images/s1.jpg" data-imagezoom="true" class="img-responsive"> </div>
					    </li>
					    <li data-thumb="<?php echo e(asset('theme_assets')); ?>/images/si2.jpg">
					         <div class="thumb-image"> <img src="<?php echo e(asset('theme_assets')); ?>/images/s2.jpg" data-imagezoom="true" class="img-responsive"> </div>
					    </li>
					    <li data-thumb="<?php echo e(asset('theme_assets')); ?>/images/si3.jpg">
					       <div class="thumb-image"> <img src="<?php echo e(asset('theme_assets')); ?>/images/s3.jpg" data-imagezoom="true" class="img-responsive"> </div>
					    </li> 
					  </ul>
				</div>
				</div>
			   	 ...
			   	 <div class="col-md-3 home-grid">
						<div class="home-product-main">
						   <div class="home-product-top">
						      <a href="#"><img src="<?php echo e(asset('theme_assets')); ?>/images/h14.jpg" alt="" class="img-responsive zoom-img"></a>
						   </div>
				      ...
				      <div class="col-md-3 home-grid">
						<div class="home-product-main">
						   <div class="home-product-top">
						      <a href="#"><img src="<?php echo e(asset('theme_assets')); ?>/images/h15.jpg" alt="" class="img-responsive zoom-img"></a>
						   </div>
							<div class="home-product-bottom">
									<h3><a href="#">Smart Shopping</a></h3>
									<p>Explore Now</p>						
					 ...
					 <div class="col-md-3 home-grid">
						<div class="home-product-main">
						   <div class="home-product-top">
						      <a href="#"><img src="<?php echo e(asset('theme_assets')); ?>/images/h16.jpg" alt="" class="img-responsive zoom-img"></a>
						   </div>
							<div class="home-product-bottom">
									<h3><a href="#">Smart Shopping</a></h3>
									<p>Explore Now</p>						
				      ...
				      <div class="col-md-3 home-grid">
						<div class="home-product-main">
						   <div class="home-product-top">
						      <a href="#"><img src="<?php echo e(asset('theme_assets')); ?>/images/h17.jpg" alt="" class="img-responsive zoom-img"></a>
						   </div>
							<div class="home-product-bottom">
									<h3><a href="#">Smart Shopping</a></h3>
									<p>Explore Now</p>						
